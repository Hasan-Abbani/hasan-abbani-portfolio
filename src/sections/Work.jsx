...
const projects = [
  { number: "01", title: "Q-TES", subtitle: "Quantum Traffic Enhancer System", type: "Quantum optimization", text: "Designed a QAOA-based system with a team to optimize urban traffic-light scheduling during an AUB challenge organized with CAMS, the AUB Quantum Club, NYU Abu Dhabi, and CERN's OQI.", href: "https://github.com/Hasan-Abbani/qaoa-traffic-optimization", tags: ["QAOA", "Python", "Graph optimization"] },
...
export default function Work() {
  ...
  return (
    <section id="projects" className="page-section projects-section">
      ...
      <div className="section-heading"><h2>Tangibles.</h2></div>
